                ...
                gang_rows.append(
                    {
                        ...
                        "deployment_days": summary["deployment_days"],
                        "deployment_months": summary["deployment_months"],
                        ...
                        "idle_windows_per_deployment_month": summary["idle_windows_per_deployment_month"],
                        "idle_days_per_deployment_month": summary["idle_days_per_deployment_month"],
                        "lost_mt": round(allocated_days * float(baseline_value), 2),
